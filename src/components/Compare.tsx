                ...
                <div className="grid grid-rows-6 grid-cols-5 w-full h-full min-w-[600px]">
                        ...
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/table_1.svg" alt="" />
                            </div>
                        </div>
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/table_2.png" alt="" />
                            </div>
                        </div>
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/table_3.svg" alt="" />
                            </div>
                        </div>
                        <div className="border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/table_4.svg" alt="" />
                            </div>
                        </div>
                        ...
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/u_check.svg" alt="" />
                            </div>
                        </div>
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex flex-col items-center space-x-2">
                                <img src="/src/assets/u_minus-circle.svg" alt="" />
                                <span className="text-xs text-[#CECECE] max-w-32 text-left">Requires setup</span>
                            </div>
                        </div>
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/u_times-circle.svg" alt="" />
                            </div>
                        </div>
                        <div className="border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="border-r border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
                                <img src="/src/assets/u_check-grey.svg" alt="" />
                            </div>
                        </div>
                        <div className="border-b border-dashed border-[#E5E5E5] flex items-center justify-center p-4">  
                            <div className="flex items-center space-x-2">
